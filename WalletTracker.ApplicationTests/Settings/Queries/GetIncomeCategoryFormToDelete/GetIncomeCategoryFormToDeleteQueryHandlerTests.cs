...
namespace WalletTracker.Application.Settings.Queries.GetIncomeCategoriesAssignedToLoggedUser.Tests
{
    public class GetIncomeCategoryFormToDeleteQueryHandlerTests
    {
        [Fact]
        public async Task Handle_ShouldReturnCommand()
        {
            // Arrange
            var query = new GetIncomeCategoryFormToDeleteQuery();
            ...
            var handler = new GetIncomeCategoryFormToDeleteQueryHandler(incomeCategoryRepositoryMock.Object, mapperMock.Object);
