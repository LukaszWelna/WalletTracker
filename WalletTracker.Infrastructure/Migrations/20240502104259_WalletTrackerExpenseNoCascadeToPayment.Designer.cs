...
namespace WalletTracker.Infrastructure.Migrations
{
    ...
    [Migration("20240502104259_WalletTrackerExpenseNoCascadeToPayment")]
    partial class WalletTrackerExpenseNoCascadeToPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WalletTracker.Domain.Entities.PaymentMethodDefault", b =>
                {
                    ...
                    b.ToTable("PaymentMethodsDefault");
                });

            modelBuilder.Entity("WalletTracker.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WalletTracker.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WalletTracker.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("WalletTracker.Domain.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
